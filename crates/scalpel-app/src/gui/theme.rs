...
pub(crate) fn configure_egui(ctx: &egui::Context) {
    ctx.set_fonts(scalpel_fonts());
    ctx.set_global_style(scalpel_style());
}

pub(crate) fn scalpel_fonts() -> FontDefinitions {
    ...
    fonts
        .families
        .insert(FontFamily::Name("scalpel-sans".into()), sans_fonts);
    ...
    fonts
        .families
        .insert(FontFamily::Name("scalpel-mono".into()), mono_fonts);
    fonts
}
...
pub(crate) fn scalpel_style() -> egui::Style {
    let mut style = egui::Style::default();
    let sans = FontFamily::Name("scalpel-sans".into());
    let mono = FontFamily::Name("scalpel-mono".into());
    ...
    style.text_styles.insert(
        ...
        FontId::new(13.5, FontFamily::Name("scalpel-sans".into())),
    );
...
pub(crate) fn mono_font_id(size: f32) -> FontId {
    FontId::new(size, FontFamily::Name("scalpel-mono".into()))
}
